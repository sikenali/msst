...
import { ref } from 'vue'
import { RiMoneyCnyCircleFill, RiBarChartLine, RiInformationLine } from '@remixicon/vue'
      ...
      <div class="header-content" :class="'theme-' + modelValue">
        ...
        <div class="header-actions">
          ...
          <button v-if="showInfoBtn" class="trend-btn" @click="toggleTrend">
            ...
            <span class="header-tooltip">往期</span>
          </button>
          <!-- 关于按钮 -->
          <button class="history-btn" @click="handleHistory">
            <RiInformationLine class="history-icon-svg" />
            <span class="header-tooltip">关于</span>
          </button>
        </div>
      </div>
    </div>
