...
const trigrams = [
  { name: '乾', angle: 0, lines: [true, true, true] },
  { name: '兑', angle: 45, lines: [true, true, false] },
  { name: '离', angle: 90, lines: [true, false, true] },
  { name: '震', angle: 135, lines: [true, false, false] },
  { name: '巽', angle: 180, lines: [false, true, true] },
  { name: '坎', angle: 225, lines: [false, true, false] },
  { name: '艮', angle: 270, lines: [false, false, true] },
  { name: '坤', angle: 315, lines: [false, false, false] },
]
</script>
